...
const CSRPage = () => {
  ...
  const galleryImages = [
    { src: '/images/csr/education/school-infrastructure.jpg', alt: 'Education Program', title: 'School Infrastructure Development' },
    { src: '/images/csr/healthcare/mobile-health-clinic.jpg', alt: 'Healthcare Camp', title: 'Mobile Health Clinic' },
    { src: '/images/csr/rural-development/water-conservation.jpg', alt: 'Rural Development', title: 'Water Conservation Project' },
    { src: '/images/csr/education/skill-training-center.jpg', alt: 'Skill Training', title: 'Vocational Training Center' },
    { src: '/images/csr/healthcare/health-camp.jpg', alt: 'Health Awareness', title: 'Health Awareness Camp' },
    { src: '/images/csr/rural-development/farmers-training.jpg', alt: 'Farmers Training', title: 'Agricultural Training Program' }
  ];
