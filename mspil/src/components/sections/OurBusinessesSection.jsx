...
const OurBusinessesSection = () => {
  ...
  const openGallery = (businessId, businessNameKey) => {
    const images = businessImageGalleries[businessId] || [];
    ...
    const processBusinessesData = () => {
      const updatedBusinesses = initialBusinessesData.map((business) => {
        ...
        if (business.id === 'sugar') {
          publicUrl = 'https://workspace.saifraza91.repl.co/api/public/download/sugar-data';
        } else if (business.id === 'ethanol') {
          publicUrl = 'https://workspace.saifraza91.repl.co/api/public/download/ethanol-data';
        } else if (business.id === 'power') {
          publicUrl = 'https://workspace.saifraza91.repl.co/api/public/download/power-data';
        } else if (business.id === 'feed') {
          publicUrl = 'https://workspace.saifraza91.repl.co/api/public/download/feed-data';
        }
  ...
  return (
    <section id="businesses" className="section-padding bg-muted/30 dark:bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <Tabs defaultValue={initialBusinessesData[0]?.id || 'sugar'} className="w-full">
